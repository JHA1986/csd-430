/*
 * ******************************************************************
 * Jonah Aney – Movie Database JavaBean 11/23/25
...
public class DbBean implements java.io.Serializable {
 ...
 public String readAll() {
     ...
     try {
         ...
         System.out.println("SQL Exception: " + e);
         return "<p>Error reading records.</p>";
     }

     try {
         sb.append("<table border='1' bgcolor='#E0FFFF'>");

// Add table headers. Updated for module-7 to use threads
         sb.append("<thead>");
         sb.append("<tr>");
         sb.append("<th>ID</th>");
...
// Add table body with rows
         ...
         System.out.println("Exception building table: " + e);
     }
